...
class API_FOOTBALL:
    def __init__(self):
        ...
        self.managers = {
            ...
            "top_Leagues":TOP_Leagues_M(),
            "important_matches": Matchs_M(),
            "matches_league":Matchs_league_M(),
    ...
    def get_top_leagues(self):
        return self.managers['top_Leagues'].class_data()
    
    def get_matches_league(self):
        return self.managers['matches_league'].class_data()
